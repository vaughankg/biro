...
function createNewSection(sectionName){
  ...
  biro.sections[sectionName] = new biroSection(ctx);
...
biroSection.prototype =
{
  ...
  transition: function(toState){
   ...
   var sLetter = biro.letters[fromText[0]];
   var eLetter = biro.letters[toText[0]];
    

   var frames = biro.utils.generateFrames(sLetter, eLetter, 3);
   biro.draw.animate(frames, 1, this.ctx); // 1 seconds duration
  }
